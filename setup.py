...
class LongVersionPyGitMaker(Command):
...
setup(
    ...
    cmdclass={"build_py": MyBuildPy,
              "make_versioneer": VersioneerMaker,
              "make_long_version_py_git": LongVersionPyGitMaker,
              },
    classifiers=[
